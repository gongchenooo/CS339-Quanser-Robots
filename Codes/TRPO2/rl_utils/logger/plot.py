...
from rl_utils.logger.bench import load_results
...
def main():
    ...
    parser.add_argument('--task_name', help = 'Title of plot', default = 'CartpoleSwingShort-v0')
    args = parser.parse_args()
    env_name = ['CartpoleSwingShort-v0']
    dirs = ['D:/大三上/人工智能/TRPO2/logs/' + name for name in env_name]
    for idx in range(len(dirs)):
        plot_results([dirs[idx]], args.num_timesteps, args.xaxis, env_name[idx], 231+idx, beta='TRPO')
    '''
