...
def get_args():
    ...
    parse.add_argument('--env-name', type=str, default='CartpoleSwingShort-v0', help='the training environment')
    ...
    parse.add_argument('--total-timesteps', type=int, default=int(1e7), help='the total frames')
    parse.add_argument('--nsteps', type=int, default=int(1e4), help='the steps to collect samples')
    parse.add_argument('--lr', type=float, default=1e-3)
    parse.add_argument('--batch-size', type=int, default=128, help='the mini batch size ot update the value function')
