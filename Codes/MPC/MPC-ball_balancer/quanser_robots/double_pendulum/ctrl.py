import numpy as np
import time
from quanser_robots.double_pendulum.double_pendulum import DoublePendulumDynamics
...
class BalanceCtrl:
    ...
    def __init__(self, long=False, dt=0.002):
        ...
        self.K = np.array([42.3191, -180.9092, -417.7666,       # P-Gains
                           31.0609, -48.4961, -43.2275,         # D-Gains
                           10.0000])                            # I-Gains
